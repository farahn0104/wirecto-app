      ...
      <section className="relative py-20 bg-gradient-to-r from-primary to-accent">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">Singapore Office</h1>
            <p className="text-xl opacity-90">Wirecto Technologies Pte. Ltd.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Asia Pacific Headquarters</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-bold text-gray-700 mb-2">Address</h3>
                  <p className="text-gray-600">
                    Wirecto Technologies Pte. Ltd.<br />
                    1 Raffles Place, #28-01<br />
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    <strong>Email:</strong> singapore@wireto.com<br />
                    <strong>Sales:</strong> sales.sg@wireto.com
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    Saturday: 9:00 AM - 1:00 PM SGT<br />
                    Sunday: Closed
                  </p>
                </div>
              </div>
              ...
              <div className="h-96 bg-gray-200 rounded-2xl mb-6">
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl">
                  <div className="text-center">
                    ...
                    <p className="text-gray-700">Singapore Location</p>
                  </div>
                </div>
              </div>
            </div>
