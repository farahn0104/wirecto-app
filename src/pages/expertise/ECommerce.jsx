      ...
      <section className="relative py-20 bg-gradient-to-r from-primary to-accent">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">eCommerce Solutions</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <p className="text-gray-600 text-lg mb-6">
                The digital era has revolutionized the way businesses operate, and e-commerce stands at the forefront of this transformation. At Wirecto, we empower businesses to thrive in the competitive online marketplace with tailored solutions, cutting-edge technology, and expert support.
              </p>
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl">
              <img src="/img/ECOMEERCE-2.jpg" alt="eCommerce Solutions" className="w-full h-96 object-cover" />
            </div>
          </div>
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  features: ['SEO', 'Social Media Marketing', 'PPC Campaigns']
                },
                {
